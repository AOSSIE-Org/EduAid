...
const Home = () => {
  ...
  return (
    <div className="popup w-screen min-h-screen bg-[#02000F] flex justify-center items-center">
      <div className="w-full h-full  bg-opacity-50 bg-custom-gradient pb-6">
        <div className="">
          <div className=" flex flex-col justify-center">
            <img src="aossie_transparent.png" alt="logo" className="w-24 mt-6 mx-6 block" />
            <div>
          ...
          <a
              ...
              className="group w-full max-w-screen overflow-hidden"
          >
              <div className="bg-[#45454599] mt-10 w-fit max-w-full mx-auto px-4 py-3 rounded-xl flex gap-4 items-center group-hover:bg-[#5a5a5a99] transition-colors duration-300">
