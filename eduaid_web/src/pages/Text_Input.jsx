...
const Text_Input = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    if (file) {
      ...
      try {
        const response = await fetch(`${REACT_APP_BASE_URL}/upload/`, {
          method: "POST",
          body: formData,
        });
  ...
  const handleSaveToLocalStorage = async () => {
    ...
    if (docUrl) {
      try {
        const response = await fetch(`${REACT_APP_BASE_URL}/get_content`, {
          method: "POST",
          headers: {
  ...
  const sendToBackend = async (data, difficulty, questionType) => {
    ...
    try {
      ...
      const response = await fetch(`${REACT_APP_BASE_URL}/${endpoint}/`, {
        method: "POST",
        body: formData,
        headers: {
          "Content-Type": "application/json",
