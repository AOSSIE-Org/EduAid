...
const Text_Input = () => {
  ...
  const ALLOWED_TYPES = ["application/pdf", "audio/mpeg"];
  ...
  const handleFileUpload = (e) => {
    ...
    if (!ALLOWED_TYPES.includes(file.type)) {
      setError("Only PDF and MP3 files are supported");
      return;
    }
        ...
        <div className="w-full max-w-2xl mx-auto border-[3px] rounded-2xl text-center px-6 py-6 border-dotted border-[#3E5063] mt-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              type="button"
              onClick={handleClick}
              className="bg-[#3e506380] text-lg rounded-2xl text-white border px-6 py-2"
            >
              Browse File
            </button>
