...
from Generator.question_filters import make_question_harder,filter_by_difficulty
import re
import json
import spacy
...
def get_mcq():
    ...
    output = MCQGen.generate_multiple_choice_questions(
        {"input_text": input_text, "max_questions": max_questions}
    )
    questions = output.get("questions",[])

    questions =filter_by_difficulty(questions,difficulty)
...
def export_pdf():
    ...
    for i, qapair in enumerate(qa_pairs, start=1):
