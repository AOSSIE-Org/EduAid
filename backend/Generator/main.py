...
import fitz
import mammoth
from Generator.mcq import generate_multiple_choice_questions
from Generator.question_filters import adjust_difficulty, filter_by_difficulty
...
class MCQGenerator:
    ...
    def generate_multiple_choice_questions(self,data):
        input_text = data["input_text"]
        max_questions = data["max_questions"]

        sentences = input_text.split(".")
        keyword_sent_mapping ={}

        for i,sentence  in enumerate(sentences[:max_questions]):
            keyword_sent_mapping[f"keyword{i}"] = sentence
        
        output = generate_multiple_choice_questions(
            keyword_sent_mapping,
            self.device,
            self.tokenizer,
            self.model,
...
class QuizSession:
    ...
    def next_question(self):
        ...
        self.current_difficulty = adjust_difficulty(
